...
class OrderAdmin(object):
	...
	# fields = ('name','mobile','valid')
	list_display = ('customer','shop','delivery_address','status','tip','freight','tax','total_price')
...
class GlobalSettingAdmin(object):
	fields = ("freight_thres","short_message_mobile","tax_rate","discount_rate","customer_service","policy_link","working_hours")
	list_display = ("freight_thres","short_message_mobile","tax_rate","discount_rate","customer_service","policy_link","working_hours")
